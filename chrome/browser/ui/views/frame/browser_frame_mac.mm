...
NativeWidgetMacNSWindow* BrowserFrameMac::CreateNSWindow(
  ...
  NSButton *minimizeButton = [ns_window standardWindowButton:NSWindowMiniaturizeButton];
  [minimizeButton setHidden:YES];

  NSButton *closeButton = [ns_window standardWindowButton:NSWindowCloseButton];
